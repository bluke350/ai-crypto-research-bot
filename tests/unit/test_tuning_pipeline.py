...
def test_tuning_pipeline_smoke(tmp_path, monkeypatch):
    ...
    argv = ["tuning_pipeline.py", "--prices-csv", str(csv_path), "--param-space", json.dumps(param_space), "--n-trials", "2", "--window", "40", "--step", "10", "--output", str(tmp_path / "artifacts")]
